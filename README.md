...
By far the most common scenario is people wanting to simply interact with the flagman network:
...
With the genesis state defined in the above JSON file, you'll need to initialize **every** gfl node
