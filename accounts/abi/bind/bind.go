...
//
// Detailed usage document and tutorial available on the go-flagman Wiki page:
// https://github.com/getflagman/go-flagman/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
