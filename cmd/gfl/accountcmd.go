...
var (
	walletCommand = cli.Command{
		...
		Description: `
    gfl wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	gfl wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    gfl account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    gfl account import [options] <keyfile>
...
func accountCreate(ctx *cli.Context) error {
	cfg := gflConfig{Node: defaultNodeConfig()}
	// Load config file.
