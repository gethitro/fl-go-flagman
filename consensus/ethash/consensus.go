...
import (
	...
	"github.com/getflagman/go-flagman/consensus/misc"
...
func calcDifficultyByzantium(time uint64, parent *types.Header) *big.Int {
	// https://github.com/getflagman/EIPs/issues/100.
	// algorithm:
	// diff = (parent_diff +
	...
	//   https://github.com/getflagman/EIPs/pull/669
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/getflagman/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +
