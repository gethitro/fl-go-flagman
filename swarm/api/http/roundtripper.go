...
see https://github.com/getflagman/go-flagman/issues/2040
Usage:

import (
 "github.com/getflagman/go-flagman/common/httpclient"
 "github.com/getflagman/go-flagman/swarm/api/http"
)
